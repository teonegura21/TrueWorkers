...
class MediaUploadService {
  ...
  // Alternative implementation for multiple image selection
  Future<List<File>> pickMultipleImages({int maxImages = 10}) async {
    try {
      ...
      // Using FilePicker to pick multiple images
      ...
      if (result != null && result.files.isNotEmpty) {
        ...
        return files.take(maxImages).toList(); // Limit to maxImages after checking for null paths
      } else {
  ...
  // Crop image - Updated for compatibility with image_cropper 8.x
